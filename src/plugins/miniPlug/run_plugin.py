"""
This script is called by the plugin-wrapper, miniPlug.js, which passes down the
...
plugin = miniPlug(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)

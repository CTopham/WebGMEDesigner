...
define([
    ...
    function miniVizControl(options) {
    ...
    miniVizControl.prototype._initWidgetEventHandlers = function () {
    ...
    miniVizControl.prototype.selectedObjectChanged = function (nodeId) {
            self = this;
    ...
    /* * * * * * * * Node Event Handling * * * * * * * */
    miniVizControl.prototype._eventCallback = function (events) {
        const self = this;
        console.log(events);
    ...
    miniVizControl.prototype._stateActiveObjectChanged = function (model, activeObjectId) {
    ...
    SimSMControl.prototype._initPN = function () {
        const self = this;
        ...
        elementIds.forEach(elementId => {
            ...
            if (node.isTypeOf(META['Place'])) {
                ...
                elementIds.forEach(nextId => {
                    ...
                    if(nextNode.isTypeOf(META['Ark']) && nextNode.getPointerId('src') === elementId) {
    ...
    miniVizControl.prototype.clearPN = function () {
        const self = this;
        self._networkRootLoaded = false;
        self._widget.destroyMachine();
    };

    miniVizControl.prototype.setFireableEvents = function (events) {
    ...
    miniVizControl.prototype.destroy = function () {
        this._detachClientEventListeners();
        this._removeToolbarItems();
    };

    miniVizControl.prototype._attachClientEventListeners = function () {
        this._detachClientEventListeners();
        WebGMEGlobal.State.on('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged, this);
    };

    miniVizControl.prototype._detachClientEventListeners = function () {
        WebGMEGlobal.State.off('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged);
    };

    miniVizControl.prototype.onActivate = function () {
    ...
    miniVizControl.prototype.onDeactivate = function () {
        this._detachClientEventListeners();
        this._hideToolbarItems();
    };

    /* * * * * * * * * * Updating the toolbar * * * * * * * * * */
    miniVizControl.prototype._displayToolbarItems = function () {
    ...
    miniVizControl.prototype._hideToolbarItems = function () {
    ...
    miniVizControl.prototype._removeToolbarItems = function () {
    ...
    miniVizControl.prototype._initializeToolbar = function () {
        var self = this,
        ...
        this._toolbarItems.push(this.$btnminiPlug);
